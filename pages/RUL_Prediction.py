...
with st.form("pred form", clear_on_submit=True, border=True):
    ...
    if submitted:
        ...
        if predicted_RUL < 10:
            st.error("Very soon, the engine will require maintenance.", icon='👨‍🔧')
        else:
            st.success("The engine is healthy, no maintenance required.", icon="✅")
